#### GDB命令速查表 
| 命令 Command|缩写 Sort|详解 Detail|
|:-----|:-----|:-----|
|run|r|运行程序|
|continue|c|让暂停的程序继续运行|
|break|b|添加断点|
|tbreak|tb|查看当前线程的调用堆栈|
...
|next|n|运行到下一行|
|step|s|如果有调用函数，则进入调用的函数内部，相当于step into|
|until|u|运行到指定的行停下来|
...
| **内容转载自 [skywind3000/awesome-cheatsheets](https://github.com/skywind3000/awesome-cheatsheets)** |
| ------------------------------------------------------------ |
